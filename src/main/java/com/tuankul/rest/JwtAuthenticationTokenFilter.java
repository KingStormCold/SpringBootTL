...
public class JwtAuthenticationTokenFilter
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (this.jwtService.validateTokenLogin(authToken)) {
            String username = this.jwtService.getUsernameFromToken(authToken);
            UserEntityJWT user = this.userService
            ...
            if (user != null) {
                ...
                UserDetails userDetail = new User(username, user.getPassword(),
